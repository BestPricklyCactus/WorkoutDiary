...
- `versionName`: `1.4`
- `versionCode`: `14`
- Исправлено сохранение состояния экранов при повороте устройства через `StoresViewModel`.
- Улучшен экран отчета: добавлена корректная вертикальная прокрутка содержимого.
...
- `StoresViewModel` выступает контейнером для Store-объектов и сохраняет их состояние при повороте экрана;
